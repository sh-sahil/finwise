...
const RecomSystem = () => {
  ...
  const generateRecommendations = (userData) => {
    const { age, monthly_income, risk_tolerance, preferred_investment_types, primary_financial_goal } = userData;
    ...
    const riskLevel = risk_tolerance === 'Low' ? 'Low' : risk_tolerance === 'Medium' ? 'Medium' : 'High';
